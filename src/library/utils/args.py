...
class Arguments:
    ...
    def __init__(self):
        ...
        parser.add_argument("--nms_window_size", type=int, default=3,
            help="Size of the window in pixels for the suppression of non maximum local peaks (NMS) of the heatmaps.")
        ...
        parser.add_argument("--down_ratio", "-g", type=float, default=4,
    ...
    def parse(self):
        ...
        assert args.nms_window_size > 0 and args.nms_window_size % 2 == 1, "'nms_window_size' should be positve and odd."
